...
public class GameObjectWithRulesTest {
    ...
    public void testFileJSONDeserializer() throws Exception {
        GameObjectWithRules<GameObject> gameObjectWithRulesTest = objectMapper.readValue(new File("src/test/resources/emptyGameObjectWithRules.json"), GameObjectWithRules.class);
        assertNotNull(gameObjectWithRulesTest);
        LOGGER.info("GameObjectWithRules JSON Decoding: {}", gameObjectWithRulesTest);
    }
}
